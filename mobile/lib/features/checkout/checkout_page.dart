  ...
  Future<void> _submit() async {
    ...
    if (user?.address == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Silakan lengkapi alamat di profil')),
      );
      return;
    }
          ...
          children: [
            ...
            if (user?.address != null)
              Container(
                ...
                child: Text(
                  '${user!.address!.label} · ${user.address!.recipient}\n'
                  '${user.address!.street}, ${user.address!.city}',
                  style: GoogleFonts.poppins(fontSize: 13, color: AppTheme.leaf900),
                ),
              )
            else
    ...
    return Row(
      children: [
        Container(
          width: 28,
          height: 28,
          decoration: BoxDecoration(color: AppTheme.leaf600, borderRadius: BorderRadius.circular(8)),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? AppTheme.leaf50 : Colors.white,
          borderRadius: BorderRadius.circular(14),
          border: Border.all(color: selected ? AppTheme.leaf600 : AppTheme.leaf100, width: selected ? 2 : 1),
        ),
        child: Row(
          children: [
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? AppTheme.leaf50 : Colors.white,
          borderRadius: BorderRadius.circular(14),
          border: Border.all(color: selected ? AppTheme.leaf600 : AppTheme.leaf200, width: selected ? 2 : 1),
        ),
